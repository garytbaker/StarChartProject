...
/*
    AprilActivity.java
    This is the java file for the April month of my StarChart app. It handles the rotation of the starchart via the seekbar
...
public class AprilActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View aprilSkyChart = findViewById(R.id.imgview_April);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                aprilSkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
