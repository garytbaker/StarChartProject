...
/*
    OctoberActivity.java
    This is the java file for the October month of my StarChart app. It handles the rotation of the starchart via the seekbar
...
public class OctoberActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View octoberSkyChart = findViewById(R.id.imgview_October);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                octoberSkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
