...
/*
    MayActivity.java
    This is the java file for the may month of my StarChart app. It handles the rotation of the starchart via the seekbar
 ...
 */
public class MayActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View maySkyChart = findViewById(R.id.imgview_may);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                maySkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
