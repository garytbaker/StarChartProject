...
/*
    JuneActivity.java
    This is the java file for the june month of my StarChart app. It handles the rotation of the starchart via the seekbar
...
public class JuneActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View juneSkyChart = findViewById(R.id.imgview_June);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                juneSkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
