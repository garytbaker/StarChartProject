...
/*
    AugustActivity.java
    This is the java file for the august month of my StarChart app. It handles the rotation of the starchart via the seekbar
 ...
 */
public class AugustActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View augustSkyChart = findViewById(R.id.imgview_August);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                augustSkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
