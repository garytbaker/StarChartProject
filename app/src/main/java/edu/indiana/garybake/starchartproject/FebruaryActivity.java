...
/*
    FebruaryActivity.java
    This is the java file for the february month of my StarChart app. It handles the rotation of the starchart via the seekbar
...
public class FebruaryActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View februarySkyChart = findViewById(R.id.imgview_February);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                februarySkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
