...
/*
    JanuaryActivity.java
    This is the java file for the january month of my StarChart app. It handles the rotation of the starchart via the seekbar
...
public class JanuaryActivity extends AppCompatActivity implements OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View backButton = findViewById(R.id.back_img_btn);  //This is getting the back button and then setting it to listen for clicks
        backButton.setOnClickListener(this);

        //this is capturing the view for the skyChart to later be rotated
        final View januarySkyChart = findViewById(R.id.imgview_January);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                januarySkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
