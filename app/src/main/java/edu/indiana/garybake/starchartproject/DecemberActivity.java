...
/*
    DecemberActivity.java
    This is the java file for the december month of my StarChart app. It handles the rotation of the starchart via the seekbar
...
public class DecemberActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View decemberSkyChart = findViewById(R.id.imgview_December);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                decemberSkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
