...
/*
    JulyActivity.java
    This is the java file for the july month of my StarChart app. It handles the rotation of the starchart via the seekbar
...
public class JulyActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View julySkyChart = findViewById(R.id.imgview_July);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                julySkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
