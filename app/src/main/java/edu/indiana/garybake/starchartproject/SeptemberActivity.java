...
/*
    SeptemberActivity.java
    This is the java file for the september month of my StarChart app. It handles the rotation of the starchart via the seekbar
 ...
 */
public class SeptemberActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View septemberSkyChart = findViewById(R.id.imgview_September);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                septemberSkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
