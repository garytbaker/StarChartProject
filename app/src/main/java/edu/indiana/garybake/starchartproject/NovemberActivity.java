...
/*
    NovemberActivity.java
    This is the java file for the November month of my StarChart app. It handles the rotation of the starchart via the seekbar
 ...
 */
public class NovemberActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View novemberSkyChart = findViewById(R.id.imgview_November);
        ...
        rotationChanger.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            {
                novemberSkyChart.setRotation(progress);  //this is a simple way to change the rotation of a view. after scouring the internet for hours, I found this myself in AndroidStudio.
            }
